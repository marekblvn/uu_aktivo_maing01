...
import { Form, FormNumber, FormText, FormTextArea } from "uu5g05-forms";
...
const UpdateActivityForm = createVisualComponent({
  //@@viewOn:statics
  uu5Tag: Config.TAG + "UpdateActivityForm",
  //@@viewOff:statics
    ...
    return (
      <Form.View>
        <Grid>
          ...
          />
          <Grid templateRows={{ xs: "repeat(2, 1fr)", s: "1fr" }} templateColumns={{ xs: "1fr", s: "repeat(2, 1fr)" }}>
            <FormNumber
            ...
            <FormNumber
              ...
              initialValue={initialValues.idealParticipants || 0}
              max={100}
